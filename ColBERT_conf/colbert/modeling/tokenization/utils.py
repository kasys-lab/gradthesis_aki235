...
def _split_into_batches_with_confidence_layer(ids, mask, confidence_layer, bsize):
    batches = []
    for offset in range(0, ids.size(0), bsize):
        batches.append((ids[offset:offset+bsize], mask[offset:offset+bsize], confidence_layer[offset:offset+bsize]))
